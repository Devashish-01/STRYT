...
import { AppContext, type ActiveContext, type AppState } from "@/store";
...
/**
 * Everything behind useApp(). Lives apart from the context and the hook so that store.ts exports no
 * component: a module that exports both loses its state on every edit under Fast Refresh, and store.ts
 * is imported by 149 files.
 */
