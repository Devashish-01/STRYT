    ...
    <div className="screen-scroll page-pad col gap-16" style={{ paddingBottom: 30 }}>
      ...
      >
        ...
        <p className="tiny muted center" style={{ textAlign: "center" }}>
          ...
          {status === "PENDING" && "Our team reviews documents manually — we'll notify you with the decision."}
          {status === "REJECTED" && "See the reviewer's note below, then resubmit."}
          {status === "NONE" && "Upload documents to apply for the STRYT Verified badge — reviewed by a real person, never auto-approved."}
        </p>
      </div>
