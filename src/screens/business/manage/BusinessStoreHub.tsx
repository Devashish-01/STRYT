...
export default function BusinessStoreHub() {
  ...
  const sections = [
    ...
    { icon: <AlertTriangle size={20} color="var(--red-600)" />, title: "Inventory", text: flaggedCount > 0 ? `${flaggedCount} item${flaggedCount === 1 ? "" : "s"} need restocking` : "Out-of-stock and low items", to: `${base}/inventory` },
