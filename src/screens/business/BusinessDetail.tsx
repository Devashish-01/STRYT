...
import { Rating, StarRow, VegDot, EmptyState, SafeImg, Pill } from "@/components/common";
...
import { BizCatalogGrid } from "./BizCatalogGrid";
...
export default function BusinessDetail() {
  ...
  // Structural "does this business take bookings at all" — null inherits the
  // resolved package's own default (most do; pharmacy/shop typically don't).
  // Distinct from b.isOpenNow, which is a TEMPORARY pause and still renders
  // its own disabled button below; this one hides the CTA entirely.
  const bookingsOn = b.bookingsEnabled ?? bizTheme.bookingsDefault;
