      ...
      <div className="screen-scroll page-pad col gap-16" style={{ paddingBottom: 90 }}>
        ...
        >
          ...
          <span className="col grow" style={{ gap: 2 }}>
            <span className="semi small" style={{ color: "var(--ink-800)" }}>Make this a group buy</span>
            <span className="tiny muted">Neighbours pool in to unlock a bulk price</span>
          </span>
        ...
        {isGroupBuy && (
          <div className="col gap-14" style={{ padding: 14, borderRadius: 12, background: "var(--brand-50)", border: "1px solid var(--brand-200)" }}>
            <div className="row gap-10">
              <div className="grow">
                <label className="tiny semi muted" style={{ display: "block", marginBottom: 6 }}>Target quantity</label>
                <input
                  className="input"
                  inputMode="numeric"
                  placeholder="e.g. 100"
              ...
              <div className="grow">
                <label className="tiny semi muted" style={{ display: "block", marginBottom: 6 }}>Target price / unit (₹)</label>
                <input
                  className="input"
                  inputMode="decimal"
                  placeholder="e.g. 499"
            ...
            <div>
              <label className="tiny semi muted" style={{ display: "block", marginBottom: 6 }}>How should it be fulfilled?</label>
            ...
            <div className="tiny muted" style={{ lineHeight: 1.5 }}>
              Providers quote you privately — other joiners never see their prices. You pick the winner, and everyone who joined gets a claim pass.
            </div>
          </div>
        )}
