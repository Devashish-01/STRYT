...
// Everything after the first network call runs in main() and returns an exit code: process.exit() while fetch
// handles are still closing aborts Node on Windows (libuv assertion, exit 127).
async function main() {
