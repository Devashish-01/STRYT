...
const filePath = path.join(ROOT, "supabase/migrations/20260955_proposal_notifications_v2.sql");
...
console.log("Successfully patched 20260955_proposal_notifications_v2.sql");
