...
-- taken:    2026-09-15T16:39:43.905Z
...
-- ════════════════════════════════════════════════════════════
-- Function EXECUTE grants (effective) (248)
-- ════════════════════════════════════════════════════════════
...
GRANT EXECUTE ON FUNCTION public.notify_on_post_recommendation() TO authenticated, postgres, service_role;
...
-- ════════════════════════════════════════════════════════════
-- Migration ledger (supabase_migrations.schema_migrations) (159)
-- ════════════════════════════════════════════════════════════
