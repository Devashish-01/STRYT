...
-- taken:    2026-09-14T20:53:11.356Z
...
GRANT EXECUTE ON FUNCTION public.notify_admins_business_pending() TO authenticated, postgres, service_role;
...
GRANT EXECUTE ON FUNCTION public.notify_on_chat_message() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_comment_mention() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_comment_reaction() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_nearby_alert() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_post_comment() TO postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_post_like() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_post_recommendation() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.notify_on_post_resolved() TO authenticated, postgres, service_role;
...
GRANT EXECUTE ON FUNCTION public.notify_on_qna_answered() TO authenticated, postgres, service_role;
...
GRANT EXECUTE ON FUNCTION public.recompute_rating_aggregates() TO authenticated, postgres, service_role;
...
GRANT EXECUTE ON FUNCTION public.sync_post_comments_count() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.sync_post_likes_count() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.sync_request_me_too() TO authenticated, postgres, service_role;

GRANT EXECUTE ON FUNCTION public.sync_request_proposal_count() TO authenticated, postgres, service_role;
...
-- ════════════════════════════════════════════════════════════
-- Migration ledger (supabase_migrations.schema_migrations) (151)
-- ════════════════════════════════════════════════════════════
