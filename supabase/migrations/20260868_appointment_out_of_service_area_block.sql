-- ============================================================
-- 20260868 — Enforce service-area boundary on appointment_create
--
-- A listing's broadcast_radius / service_radius_km now blocks bookings when
-- the customer is outside range (client + server). Fails open when either
-- location is missing. Same 17-param signature — plain CREATE OR REPLACE.
-- ============================================================
