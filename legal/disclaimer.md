...
## 1. STRYT is a platform, not a party to your transactions

STRYT is an **intermediary** that helps neighbours discover and coordinate with each other. STRYT does **not** sell the goods or services listed, does not employ or supervise Sellers or Providers, and is **not a party** to any transaction, appointment, deal, queue visit, or walk-in between Users. Any contract for goods or services is **directly between the customer and the Seller/Provider**. STRYT is not responsible for their performance, quality, safety, legality, or conduct.

---

## 2. No payment handling — no refunds by STRYT

STRYT is **not** a bank, wallet, payment aggregator, payment gateway, or escrow agent, and never holds, processes, or controls your money. Payments happen **directly between you and the Seller** via UPI or cash — including a self-chosen "Pay any amount" custom payment with no booking attached. The in-app "I have paid" / "confirm" / "reject" actions and any "held"/"released" labels are **status records only** — not proof of payment and not a STRYT-operated escrow. **STRYT cannot and does not issue refunds.** Verify the recipient and that you received what you paid for before confirming. See the [Refund & Cancellation Policy](refund-cancellation-policy.md).
...
Listings, catalogues, prices, sale prices, stock, hours, "open/closed" status, availability, ratings, and profile details are provided by Users and are **not independently verified** by STRYT. They may be inaccurate, out of date, or misleading. Rely on them at your own risk and confirm important details directly with the Seller. The same applies to **Places to Visit** submitted for the Map (Terms §16A) — STRYT does not warrant that a submitted Place exists, is safe or accessible, or is accurately described.

---

## 5. Verification badge is not a guarantee

A **"STRYT Verified"** badge means only that a human reviewer checked certain documents **at a point in time**. It is **not** a guarantee of a Seller's or Provider's identity, quality, licensing, solvency, safety, or future conduct, and it does not transfer any responsibility to STRYT. Exercise your own judgement.
...
## 8. Notifications and time-sensitive information

Notifications (in-app, web push, and app push) may be **delayed, duplicated, or not delivered** due to device, network, operating-system, or third-party infrastructure factors. Do not rely on notifications as your only source of time-critical information (e.g. a queue turn or booking change).

---

## 9. Safety and in-person interactions

STRYT enables real-world meetings and payments between people who may be strangers. **STRYT does not conduct background checks** on Users and is **not responsible for the conduct, safety, or honesty of any User**, whether online or in person. Safety tools (live location, emergency contacts, one-time location requests, tracking links) are aids, not guarantees of safety. Take sensible precautions and use your own judgement when meeting or transacting.
...
Content on the Platform, including community posts, is provided by Users for general information and is **not** professional, legal, financial, medical, or safety advice. Verify independently before relying on it.
