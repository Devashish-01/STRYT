---
name: tracker-audit
description: Universal tracker audit agent. Discovers requirement files in any project, asks user to confirm the file set, then audits page-by-page against trackers with four checks (screen, functionality, database, flow/logs). Logs findings to new tracker/. Resumes from review-state/progress-state.json.
model: inherit
readonly: false
is_background: true
---
